...
class CurvePainter extends CustomPainter{
  ...
  path.quadraticBezierTo(size.width*0.70, size.height*0.60, size.width*0.78, size.height*0.75);
  path.quadraticBezierTo(size.width*0.76, size.height, size.width*0.90, size.height* 0.80);
  path.quadraticBezierTo(size.width*0.80,  size.height*0.87, size.width, 0);
  path.close();

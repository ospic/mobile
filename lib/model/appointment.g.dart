...
class _$Appointment extends Appointment {
  ...
  _$Appointment._({this.success, this.appointment, this.staff}) : super._() {
    if (appointment == null) {
      throw new BuiltValueNullFieldError('Appointment', 'appointment');
    }
    if (staff == null) {
      throw new BuiltValueNullFieldError('Appointment', 'staff');
    }
  }
...
class AppointmentBuilder implements Builder<Appointment, AppointmentBuilder> {
  ...
  AppointmentBuilder get _$this {
    if (_$v != null) {
      ...
      _appointment = _$v.appointment?.toBuilder();

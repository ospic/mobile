...
class _$Privilege extends Privilege {
  ...
  factory _$Privilege([void Function(PrivilegeBuilder)? updates]) =>
      (new PrivilegeBuilder()..update(updates))._build();

  _$Privilege._({this.id, this.name, required this.roles}) : super._() {
    BuiltValueNullFieldError.checkNotNull(roles, r'Privilege', 'roles');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'Privilege')
          ..add('id', id)
          ..add('name', name)
          ..add('roles', roles))
        .toString();
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'Privilege', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);

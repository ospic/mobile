...
class InfoTab extends StatelessWidget {
  ...
  FutureBuilder<Response<ConsultationPayload>> _buildBody(BuildContext context,
      int id) {
  ...
  Widget _buildConsultationWidget(BuildContext context,
      ConsultationPayload? consultation) {
    final Staff? staff = consultation?.staff;
    final String staffName = staff == null ? 'Un-assigned' : (staff.fullName ==
        null ? staff.username! : staff.fullName!);
    return Container(
